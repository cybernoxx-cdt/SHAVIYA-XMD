// ============================================================
//   plugins/settings.js — SHAVIYA-XMD
...
│
├─❏ *🎨 CUSTOMIZATION*
│  ├─∘ *Pack Name:*   ${config.PACKNAME || 'SHAVIYA-XMD'}
        ...
        return await conn.sendMessage(from, {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: '⚙️ SHAVIYA-XMD SETTINGS',
                    serverMessageId: 143
                }
            }
        }, { quoted: FakeVCard });
