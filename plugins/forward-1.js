...
cmd({
  ...
  if (!quoted) {
    return reply(
      "📤 *Forward Usage*\n\nForward කරන්නට ඕනේ message එකට *reply* කරලා *.fwd2* type කරන්න.\n\n" +
      "✅ Single JID: *.fwd2 120363382037700734@g.us*\n" +
      "✅ Multi JID (max 20): *.fwd2 jid1,jid2,jid3*\n" +
