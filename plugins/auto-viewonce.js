// ============================================================
//   plugins/auto-viewonce.js — SHAVIYA-XMD  (HARD FIX)
...
// NOTE: manual `.vv` retrieve command intentionally NOT registered here —
// vv.js already owns pattern 'vv' (avoids duplicate-command collision).
// This file only keeps the background auto-capture listener + `.autovv` toggle below.
