...
// ── JSON data files ───────────────────────────────────────
const VOICE_FILE   = path.join(__dirname, '../shaviya_data/autovoice.json');
const STICKER_FILE = path.join(__dirname, '../shaviya_data/autosticker.json');
const REPLY_FILE   = path.join(__dirname, '../shaviya_data/autoreply.json');
