...
// Baileys fallback loader (same as your other plugins)
let baileys;
try {
...
cmd({
    pattern: 'car',
    alias: ['highway', 'rush', 'highwayrush'],
    desc: 'Play Highway Rush game inside WhatsApp',
    category: 'game',
    react: '🎮',
    filename: __filename
